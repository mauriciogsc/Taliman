##################################################
###
### Diretivas de MAKE para o construto: Tst-Dis
### Gerado a partir de: tst-dis.comp
###
...
all : limpa \
   ...
   $(Fobj)\disaster.obj   $(Fobj)\tst_dis.obj   $(Fobj)\bcdarit.obj \
   $(Fobj)\breakpnt.obj   $(Fobj)\counters.obj   $(Fobj)\dynspac.obj \
...
$(Fobj)\tst_dis.obj :  {$(Pcpp)}\tst_dis.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Pinc)}cte_str.inc          {$(Phpp)}disaster.hpp         \
    {$(Phpp)}dynspac.hpp          {$(Phpp)}exceptn.hpp          {$(Phpp)}gnrctest.hpp         \
    {$(Phpp)}logger.hpp           {$(Phpp)}message.hpp          {$(Phpp)}readtest.hpp         \
    {$(Phpp)}simplist.hpp         {$(Phpp)}sioctrl.hpp          {$(Phpp)}sls_elem.hpp         \
    {$(Phpp)}string.hpp           {$(Phpp)}symbtab.hpp          {$(Pinc)}talisman_constants.inc \
    {$(Phpp)}tst_dis.hpp          {$(Phpp)}tst_rtst.hpp         {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-Dis
###
##################################################
