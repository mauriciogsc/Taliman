##################################################
###
### Diretivas de MAKE para o construto: Tst-sio
### Gerado a partir de: tst-sio.comp
###
...
all : limpa \
   ...
   $(Fobj)\sioctrl.obj   $(Fobj)\tst_sio.obj   $(Fobj)\bcdarit.obj \
...
$(Fobj)\tst_sio.obj :  {$(Pcpp)}\tst_sio.cpp \
    ...
    {$(Phpp)}tst_sio.hpp          {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-sio
###
##################################################
