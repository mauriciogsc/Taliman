##################################################
###
### Diretivas de MAKE para o construto: TalismanTestDll
### Gerado a partir de: TalismanTestDll.comp
###
...
all : limpa \
   ...
   $(Finc)\str_dsp.inc   $(Finc)\str_exc.inc   $(Finc)\str_glb.inc \
   $(Finc)\str_global.inc   $(Finc)\str_log.inc   $(Finc)\str_msg.inc \
   $(Finc)\str_sio.inc   $(Finc)\str_sls.inc   $(Finc)\str_smt.inc \
   $(Finc)\str_str.inc   $(Finc)\str_tim.inc   $(Finc)\str_tst.inc \
   $(Finc)\str_ver.inc   $(Ftable)\string.table   $(Fobj)\bcdarit.obj \
   $(Fobj)\breakpnt.obj   $(Fobj)\buffer.obj   $(Fobj)\configfl.obj \
   $(Fobj)\counters.obj   $(Fobj)\disaster.obj   $(Fobj)\dynspac.obj \
   $(Fobj)\exceptn.obj   $(Fobj)\global.obj   $(Fobj)\environ.obj \
...
Construto : \
   $(Fobj)\bcdarit.obj   $(Fobj)\breakpnt.obj   $(Fobj)\buffer.obj \
   $(Fobj)\configfl.obj   $(Fobj)\counters.obj   $(Fobj)\disaster.obj \
   $(Fobj)\dynspac.obj   $(Fobj)\exceptn.obj   $(Fobj)\global.obj \
   $(Fobj)\environ.obj   $(Fobj)\gnrctest.obj   $(Fobj)\int_cnt.obj \
...
##################################################
###
### Fim de diretivas MAKE para o construto: TalismanTestDll
###
##################################################
