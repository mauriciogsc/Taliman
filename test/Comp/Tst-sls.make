##################################################
###
### Diretivas de MAKE para o construto: Tst-sls
### Gerado a partir de: tst-sls.comp
###
...
all : limpa \
   ...
   $(Fobj)\simplist.obj   $(Fobj)\tst_sls.obj   $(Fobj)\bcdarit.obj \
   ...
   $(Fobj)\msgtime.obj   $(Fobj)\readtest.obj   $(Fobj)\sioctrl.obj \
...
$(Fobj)\tst_sls.obj :  {$(Pcpp)}\tst_sls.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}counters.hpp         {$(Phpp)}dynspac.hpp          \
    ...
    {$(Pinc)}talisman_constants.inc {$(Phpp)}tst_rtst.hpp         {$(Phpp)}tst_sls.hpp          \
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-sls
###
##################################################
