##################################################
###
### Diretivas de MAKE para o construto: Tst-Rnd
### Gerado a partir de: tst-rnd.comp
###
...
all : limpa \
   ...
   $(Finc)\str_ver.inc   $(Ftable)\string.table   $(Fobj)\randgen.obj \
   $(Fobj)\tst_rnd.obj   $(Fobj)\bcdarit.obj   $(Fobj)\breakpnt.obj \
...
$(Fobj)\tst_rnd.obj :  {$(Pcpp)}\tst_rnd.cpp \
    ...
    {$(Phpp)}symbtab.hpp          {$(Pinc)}talisman_constants.inc {$(Phpp)}tst_rnd.hpp          \
...
Construto : \
   $(Fobj)\randgen.obj   $(Fobj)\tst_rnd.obj   $(Fobj)\bcdarit.obj \
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-Rnd
###
##################################################
