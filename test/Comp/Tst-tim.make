##################################################
###
### Diretivas de MAKE para o construto: Tst-tim
### Gerado a partir de: tst-tim.comp
###
...
all : limpa \
   ...
   $(Fobj)\time.obj   $(Fobj)\tst_tim.obj   $(Fobj)\bcdarit.obj \
   ...
   $(Fobj)\msgstr.obj   $(Fobj)\msgtime.obj   $(Fobj)\readtest.obj \
   $(Fobj)\simplist.obj   $(Fobj)\sioctrl.obj   $(Fobj)\sls_elem.obj \
   $(Fobj)\string.obj   $(Fobj)\symbtab.obj   $(Fobj)\tracer.obj \
   $(Fobj)\verifier.obj \
   Construto
...
$(Fobj)\time.obj :  {$(Pcpp)}\time.cpp \
   ...
   CL /D_TEST_TIM $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err

$(Fobj)\tst_tim.obj :  {$(Pcpp)}\tst_tim.cpp \
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-tim
###
##################################################
