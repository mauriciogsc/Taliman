##################################################
###
### Diretivas de MAKE para o construto: Tst-buf
### Gerado a partir de: tst-buf.comp
###
...
all : limpa \
   ...
   $(Finc)\str_ver.inc   $(Ftable)\string.table   $(Fobj)\buffer.obj \
   $(Fobj)\tst_buf.obj   $(Fobj)\bcdarit.obj   $(Fobj)\breakpnt.obj \
   ...
   $(Fobj)\logger.obj   $(Fobj)\main.obj   $(Fobj)\message.obj \
...
$(Fobj)\tst_buf.obj :  {$(Pcpp)}\tst_buf.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}buffer.hpp           {$(Phpp)}exceptn.hpp          \
    ...
    {$(Phpp)}tst_buf.hpp          {$(Phpp)}tst_rtst.hpp         {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err
...
Construto : \
   $(Fobj)\buffer.obj   $(Fobj)\tst_buf.obj   $(Fobj)\bcdarit.obj \
   ...
   $(Fobj)\msgtime.obj   $(Fobj)\readtest.obj   $(Fobj)\simplist.obj \
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-buf
###
##################################################
