##################################################
###
### Diretivas de MAKE para o construto: Tst-log
### Gerado a partir de: tst-log.comp
###
...
all : limpa \
   $(Finc)\str_env.inc   $(Finc)\str_bcd.inc   $(Finc)\str_cnt.inc \
   $(Finc)\str_dsp.inc   $(Finc)\str_dis.inc   $(Finc)\str_exc.inc \
   ...
   $(Fobj)\logger.obj   $(Fobj)\tst_log.obj   $(Fobj)\main.obj \
   ...
   $(Fobj)\int_cnt.obj   $(Fobj)\int_dsp.obj   $(Fobj)\message.obj \
...
$(Fobj)\tst_log.obj :  {$(Pcpp)}\tst_log.cpp \
    ...
    {$(Phpp)}symbtab.hpp          {$(Pinc)}talisman_constants.inc {$(Phpp)}tst_log.hpp          \
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-log
###
##################################################
