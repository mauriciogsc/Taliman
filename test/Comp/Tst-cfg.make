##################################################
###
### Diretivas de MAKE para o construto: Tst-cfg
### Gerado a partir de: tst-cfg.comp
###
...
all : limpa \
   ...
   $(Ftable)\string.table   $(Fobj)\configfl.obj   $(Fobj)\tst_cfg.obj \
...
$(Fobj)\tst_cfg.obj :  {$(Pcpp)}\tst_cfg.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}configfl.hpp         {$(Phpp)}exceptn.hpp          \
    {$(Phpp)}gnrctest.hpp         {$(Phpp)}message.hpp          {$(Phpp)}readtest.hpp         \
    {$(Phpp)}simplist.hpp         {$(Phpp)}sioctrl.hpp          {$(Phpp)}sls_elem.hpp         \
    {$(Phpp)}string.hpp           {$(Phpp)}symbtab.hpp          {$(Pinc)}talisman_constants.inc \
    {$(Phpp)}tst_cfg.hpp          {$(Phpp)}tst_rtst.hpp         {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err
...
Construto : \
   $(Fobj)\configfl.obj   $(Fobj)\tst_cfg.obj   $(Fobj)\bcdarit.obj \
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-cfg
###
##################################################
