##################################################
###
### Diretivas de MAKE para o construto: Tst-Rdt
### Gerado a partir de: tst-rdt.comp
###
...
all : limpa \
   ...
   $(Fobj)\readtest.obj   $(Fobj)\tst_rdt.obj   $(Fobj)\bcdarit.obj \
   ...
   $(Fobj)\msgtime.obj   $(Fobj)\simplist.obj   $(Fobj)\sioctrl.obj \
...
$(Fobj)\tst_rdt.obj :  {$(Pcpp)}\tst_rdt.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}exceptn.hpp          {$(Phpp)}gnrctest.hpp         \
    {$(Phpp)}message.hpp          {$(Phpp)}readtest.hpp         {$(Phpp)}simplist.hpp         \
    {$(Phpp)}sioctrl.hpp          {$(Phpp)}sls_elem.hpp         {$(Phpp)}string.hpp           \
    {$(Phpp)}symbtab.hpp          {$(Pinc)}talisman_constants.inc {$(Phpp)}tst_rdt.hpp          \
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-Rdt
###
##################################################
