##################################################
###
### Diretivas de MAKE para o construto: Tst-Main
### Gerado a partir de: tst-main.comp
###
...
$(Fobj)\tst_tst.obj :  {$(Pcpp)}\tst_tst.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}counters.hpp         {$(Pinc)}cte_str.inc          \
    {$(Phpp)}dynspac.hpp          {$(Phpp)}environ.hpp          {$(Phpp)}exceptn.hpp          \
    {$(Phpp)}global.hpp           {$(Phpp)}gnrctest.hpp         {$(Phpp)}logger.hpp           \
    {$(Phpp)}message.hpp          {$(Phpp)}msgbin.hpp           {$(Phpp)}msgstr.hpp           \
    ...
    {$(Phpp)}tst_tst.hpp          {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-Main
###
##################################################
