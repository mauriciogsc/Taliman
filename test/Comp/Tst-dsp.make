##################################################
###
### Diretivas de MAKE para o construto: Tst-dsp
### Gerado a partir de: tst-dsp.comp
###
...
all : limpa \
   ...
   $(Fobj)\dynspac.obj   $(Fobj)\int_dsp.obj   $(Fobj)\tst_dsp.obj \
   $(Fobj)\bcdarit.obj   $(Fobj)\breakpnt.obj   $(Fobj)\counters.obj \
   $(Fobj)\disaster.obj   $(Fobj)\environ.obj   $(Fobj)\exceptn.obj \
...
$(Fobj)\tst_dsp.obj :  {$(Pcpp)}\tst_dsp.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}dynspac.hpp          {$(Phpp)}exceptn.hpp          \
    {$(Phpp)}gnrctest.hpp         {$(Phpp)}message.hpp          {$(Phpp)}readtest.hpp         \
    {$(Phpp)}simplist.hpp         {$(Phpp)}sioctrl.hpp          {$(Phpp)}sls_elem.hpp         \
    {$(Phpp)}string.hpp           {$(Phpp)}symbtab.hpp          {$(Pinc)}talisman_constants.inc \
    {$(Phpp)}tst_dsp.hpp          {$(Phpp)}tst_rtst.hpp         {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-dsp
###
##################################################
