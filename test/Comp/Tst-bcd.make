##################################################
###
### Diretivas de MAKE para o construto: Tst-bcd
### Gerado a partir de: tst-bcd.comp
###
...
all : limpa \
   ...
   $(Fobj)\bcdarit.obj   $(Fobj)\tst_bcd.obj   $(Fobj)\breakpnt.obj \
...
$(Fobj)\tst_bcd.obj :  {$(Pcpp)}\tst_bcd.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}dynspac.hpp          {$(Phpp)}exceptn.hpp          \
    {$(Phpp)}gnrctest.hpp         {$(Phpp)}message.hpp          {$(Phpp)}randgen.hpp          \
    {$(Phpp)}readtest.hpp         {$(Phpp)}simplist.hpp         {$(Phpp)}sioctrl.hpp          \
    {$(Phpp)}sls_elem.hpp         {$(Pinc)}str_tst.inc          {$(Phpp)}string.hpp           \
    {$(Phpp)}symbtab.hpp          {$(Pinc)}talisman_constants.inc {$(Phpp)}tst_bcd.hpp          \
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-bcd
###
##################################################
