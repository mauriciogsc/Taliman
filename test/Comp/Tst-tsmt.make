##################################################
###
### Diretivas de MAKE para o construto: Tst-tsmt
### Gerado a partir de: tst-tsmt.comp
###
...
all : limpa \
   ...
   $(Fobj)\symbtab.obj   $(Fobj)\tsymbtab.obj   $(Fobj)\tst_tsmt.obj \
...
$(Fobj)\tsymbtab.obj :  {$(Pcpp)}\tsymbtab.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}dynspac.hpp          {$(Phpp)}exceptn.hpp          \
    {$(Phpp)}message.hpp          {$(Phpp)}simplist.hpp         {$(Phpp)}sls_elem.hpp         \
    {$(Pinc)}str_smt.inc          {$(Phpp)}string.hpp           {$(Pinc)}talisman_constants.inc \
    {$(Phpp)}tsymbtab.hpp         {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err

$(Fobj)\tst_tsmt.obj :  {$(Pcpp)}\tst_tsmt.cpp \
    ...
    {$(Phpp)}tst_tsmt.hpp         {$(Phpp)}tsymbtab.hpp         {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-tsmt
###
##################################################
