##################################################
###
### Diretivas de MAKE para o construto: Tst-env
### Gerado a partir de: tst-env.comp
###
...
all : limpa \
   $(Finc)\str_bcd.inc   $(Finc)\str_cfg.inc   $(Finc)\str_cnt.inc \
   $(Finc)\str_dis.inc   $(Finc)\str_dsp.inc   $(Finc)\str_env.inc \
   $(Finc)\str_exc.inc   $(Finc)\str_glb.inc   $(Finc)\str_global.inc \
   $(Finc)\str_log.inc   $(Finc)\str_msg.inc   $(Finc)\str_sio.inc \
   $(Finc)\str_sls.inc   $(Finc)\str_smt.inc   $(Finc)\str_str.inc \
   $(Finc)\str_tim.inc   $(Finc)\str_tst.inc   $(Finc)\str_ver.inc \
   $(Ftable)\string.table   $(Fobj)\environ.obj   $(Fobj)\tst_env.obj \
   $(Fobj)\bcdarit.obj   $(Fobj)\breakpnt.obj   $(Fobj)\configfl.obj \
   ...
   $(Fobj)\main.obj   $(Fobj)\message.obj   $(Fobj)\msgbcd.obj \
   $(Fobj)\msgbin.obj   $(Fobj)\msgstr.obj   $(Fobj)\msgtime.obj \
   $(Fobj)\randgen.obj   $(Fobj)\readtest.obj   $(Fobj)\simplist.obj \
...
$(Finc)\str_cfg.inc :  {$(Pstr)}\str_cfg.str
    $(Fferram)\GENSTRID  /D$(Fstr)  /E$(Fstr)\$(@B).str /T$(Finc)\$(@B).inc >> $(Ferr)\$(NOME).err
...
$(Fobj)\tst_env.obj :  {$(Pcpp)}\tst_env.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}environ.hpp          {$(Phpp)}exceptn.hpp          \
    ...
    {$(Phpp)}tst_env.hpp          {$(Phpp)}tst_rtst.hpp         {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err
...
$(Fobj)\configfl.obj :  {$(Pcpp)}\configfl.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}configfl.hpp         {$(Phpp)}counters.hpp         \
    ...
    {$(Phpp)}sioctrl.hpp          {$(Phpp)}sls_elem.hpp         {$(Pinc)}str_cfg.inc          \
    {$(Phpp)}string.hpp           {$(Phpp)}symbtab.hpp          {$(Pinc)}talisman_constants.inc \
...
$(Fobj)\symbtab.obj :  {$(Pcpp)}\symbtab.cpp \
    ...
    {$(Pinc)}str_smt.inc          {$(Phpp)}string.hpp           {$(Phpp)}symbtab.hpp          \
    {$(Pinc)}talisman_constants.inc {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err
...
Construto : \
   $(Fobj)\environ.obj   $(Fobj)\tst_env.obj   $(Fobj)\bcdarit.obj \
   $(Fobj)\breakpnt.obj   $(Fobj)\configfl.obj   $(Fobj)\counters.obj \
   $(Fobj)\disaster.obj   $(Fobj)\dynspac.obj   $(Fobj)\exceptn.obj \
   ...
   $(Fobj)\msgstr.obj   $(Fobj)\msgtime.obj   $(Fobj)\randgen.obj \
   $(Fobj)\readtest.obj   $(Fobj)\simplist.obj   $(Fobj)\sioctrl.obj \
   $(Fobj)\sls_elem.obj   $(Fobj)\string.obj   $(Fobj)\symbtab.obj \
   $(Fobj)\time.obj   $(Fobj)\tracer.obj   $(Fobj)\verifier.obj
   SET CL=
   CD  $(Fobj)
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-env
###
##################################################
