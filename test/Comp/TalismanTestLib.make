##################################################
###
### Diretivas de MAKE para o construto: TalismanTestLib
### Gerado a partir de: TalismanTestLib.comp
###
...
all : limpa \
   ...
   $(Ftable)\string.table   $(Fobj)\bcdarit.obj   $(Fobj)\buffer.obj \
   $(Fobj)\configfl.obj   $(Fobj)\counters.obj   $(Fobj)\disaster.obj \
   $(Fobj)\dynspac.obj   $(Fobj)\environ.obj   $(Fobj)\exceptn.obj \
   $(Fobj)\global.obj   $(Fobj)\gnrctest.obj   $(Fobj)\int_cnt.obj \
   $(Fobj)\int_dsp.obj   $(Fobj)\logger.obj   $(Fobj)\message.obj \
   $(Fobj)\msgbcd.obj   $(Fobj)\msgbin.obj   $(Fobj)\msgstr.obj \
...
$(Fobj)\buffer.obj :  {$(Pcpp)}\buffer.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}buffer.hpp           {$(Phpp)}counters.hpp         \
    {$(Phpp)}dynspac.hpp          {$(Phpp)}exceptn.hpp          {$(Phpp)}message.hpp          \
    {$(Phpp)}simplist.hpp         {$(Phpp)}sls_elem.hpp         {$(Phpp)}string.hpp           \
    {$(Phpp)}symbtab.hpp          {$(Pinc)}talisman_constants.inc {$(Pinc)}typeidmessageitem.inc
    CL $(O) $(CDB) $(DEFS) /Fo$(Fobj)\  $(Fcpp)\$(@B).cpp >> $(Ferr)\$(NOME).err
...
Construto : \
   $(Fobj)\bcdarit.obj   $(Fobj)\buffer.obj   $(Fobj)\configfl.obj \
...
##################################################
###
### Fim de diretivas MAKE para o construto: TalismanTestLib
###
##################################################
