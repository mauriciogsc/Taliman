##################################################
###
### Diretivas de MAKE para o construto: Tst-exc
### Gerado a partir de: tst-exc.comp
###
...
all : limpa \
   ...
   $(Finc)\str_smt.inc   $(Finc)\str_str.inc   $(Finc)\str_texc.inc \
   $(Finc)\str_tim.inc   $(Finc)\str_tst.inc   $(Finc)\str_ver.inc \
   $(Ftable)\string.table   $(Fobj)\exceptn.obj   $(Fobj)\tst_exc.obj \
...
$(Finc)\str_texc.inc :  {$(Pstr)}\str_texc.str
    $(Fferram)\GENSTRID  /D$(Fstr)  /E$(Fstr)\$(@B).str /T$(Finc)\$(@B).inc >> $(Ferr)\$(NOME).err
...
$(Fobj)\tst_exc.obj :  {$(Pcpp)}\tst_exc.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Phpp)}counters.hpp         {$(Phpp)}dynspac.hpp          \
    ...
    {$(Pinc)}str_exc.inc          {$(Pinc)}str_texc.inc         {$(Phpp)}string.hpp           \
    {$(Phpp)}symbtab.hpp          {$(Pinc)}talisman_constants.inc {$(Phpp)}tst_exc.hpp          \
...
Construto : \
   $(Fobj)\exceptn.obj   $(Fobj)\tst_exc.obj   $(Fobj)\bcdarit.obj \
   $(Fobj)\breakpnt.obj   $(Fobj)\counters.obj   $(Fobj)\disaster.obj \
   $(Fobj)\dynspac.obj   $(Fobj)\environ.obj   $(Fobj)\global.obj \
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-exc
###
##################################################
