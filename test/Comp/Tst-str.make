##################################################
###
### Diretivas de MAKE para o construto: Tst-str
### Gerado a partir de: tst-str.comp
###
...
all : limpa \
   ...
   $(Fobj)\string.obj   $(Fobj)\tst_str.obj   $(Fobj)\bcdarit.obj \
...
$(Fobj)\tst_str.obj :  {$(Pcpp)}\tst_str.cpp \
    {$(Phpp)}bcdarit.hpp          {$(Pinc)}cte_str.inc          {$(Phpp)}exceptn.hpp          \
...
##################################################
###
### Fim de diretivas MAKE para o construto: Tst-str
###
##################################################
